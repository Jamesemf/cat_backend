"""Audience fan-out when a sighting is committed: nearby explorers.
...
here. This task covers the area-based audience: users who explored tiles near
the sighting get "nearby_sighting" or "new_cat", gated by the users.notify_*
preference columns.
"""
